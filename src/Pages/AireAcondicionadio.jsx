...
export const AireAcondicionado = () => {
  ...
  return (
    <div className='flex'>
      ...
      <Modal display={display} title="Filtrar Información" subTitle='Aire acondicionado'>
      ...
      <div className='px-10 py-5 w-full bg-slate-50 flex flex-col gap-5'>
        <div className='py-4 text-transparent bg-clip-text bg-gradient-to-br from-orange-600 to-orange-300'><h2 className='text-8xl font-extrabold'>Aire Acondicionado</h2></div>
          ...
          <tbody>
            {
              array.map(registro => (
                <tr key={registro} className='text-center border-b border-b-gray-400'>
                  <td className='py-2'><Link to='/aire-acondicionado/001250923' className='transition-all duration-300 hover:text-slate-500'>001250923</Link></td>
                  <td>NISSAN</td>
                  <td>SENTRA</td>
                  <td>2020</td>
                  <td>50,000</td>
