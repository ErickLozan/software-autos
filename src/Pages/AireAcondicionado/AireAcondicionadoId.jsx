...
export const AireAcondicionadoId = () => {
  return (
    <div className="flex">
      <Navigation />
      ...
      <div className="w-full h-screen px-10 py-5 flex flex-col gap-10 bg-slate-50 overflow-y-scroll">
        ...
        <Link to='/aire-acondicionado' className="flex items-center text-lg text-blue-700 transition-all duration-300 hover:text-blue-400"><span className="material-symbols-outlined">arrow_back</span> Regresar</Link>

        <div className="flex flex-col gap-5">
          <div>
            <div className="py-3 text-transparent bg-clip-text bg-gradient-to-br from-slate-900 to-slate-600"><h1 className="text-6xl font-extrabold">Aire Acondicionado</h1></div>
          ...
          <div className="flex gap-16">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                <span className="text-2xl">$1200<span className="text-sm">MXN</span></span>
              </div>

              <div className="flex flex-col gap-3">
                <h3 className="text-4xl font-bold">Costo de mano de obra</h3>
                <span className="text-2xl">$2000<span className="text-sm">MXN</span></span>
              </div>
            </div>
